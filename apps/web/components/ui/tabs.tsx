...
/* PATCHED — upstream mismatch.
   shadcn's Lyra tabs ship "data-horizontal:" / "group-data-horizontal/tabs:"
   variants, but Base UI renders data-orientation="horizontal" and no bare
   data-horizontal attribute. Every one of those utilities was therefore dead:
   the root stayed flex-row (tab list beside the panel instead of above it) and
   the active-tab underline was positioned for the wrong axis. Rewritten to
   attribute-value selectors, data-[orientation=...]. Re-apply after any
   `shadcn add tabs`, which would overwrite this file. */
